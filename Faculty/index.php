...
{
$ret=mysqli_query($con,"SELECT * FROM users WHERE userEmail='".$_POST['username']."' and password='".($_POST['password'])."'");
...
$log=mysqli_query($con,"insert into userlog(userId,username,userip) values('".$_SESSION['id']."','".$_SESSION['login']."','$uip')");
...
$_SESSION['login']=$_POST['username'];	
$uip=$_SERVER['REMOTE_ADDR'];
mysqli_query($con,"insert into userlog(username,userip) values('".$_SESSION['login']."','$uip')");
...
$query=mysqli_query($con,"SELECT * FROM users WHERE userEmail='$email' and Mobileno='$Mobileno'");
$num=mysqli_fetch_array($query);
if($num>0)
{
mysqli_query($con,"update users set password='$password' WHERE userEmail='$email' and Mobileno='$Mobileno' ");
