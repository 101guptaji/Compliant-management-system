...
$query=mysqli_query($con,"insert into tblcomplaints(userId,complaintType,complaintDetails) values('$uid','$complaintype','$complaintdetials')");
...
<select name="complaintype" class="form-control" required="">
                <option value=" Complaint"> Academic</option>
				<option value=" Complaint"> General</option>
                  <option value="General Query">Facilities and Infrastructure</option>
