...
$query=mysqli_query($con,"update users set fullName='$fname',gender='$gender', Mobileno='$contactno',department='$department',catagory='$catagory' where userEmail='".$_SESSION['login']."'");
if($query)
{
...
<div class="col-sm-4">
<input type="text" name="gender" required="required" value="<?php echo htmlentities($row['gender']);?>" class="form-control" >
 </div>
<label class="col-sm-2 col-sm-2 control-label">Enrollment Number </label>
 <div class="col-sm-4">
<input type="enroll" name="Enrollno" required="required" value="<?php echo htmlentities($row['Enrollno']);?>" class="form-control" 
...
<label class="col-sm-2 col-sm-2 control-label">Mobile number</label>
 <div class="col-sm-4">
<input type="text" name="contactno" required="required" value="<?php echo htmlentities($row['Mobileno']);?>" class="form-control">
</div>
<label class="col-sm-2 col-sm-2 control-label">Department</label>
<div class="col-sm-4">
<textarea  name="address" required="required" class="form-control"><?php echo htmlentities($row['department']);?></textarea>
</div>
</div>
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Catagory/ year </label>
<div class="col-sm-4">
<input type="text" name="catagory" required="required" value="<?php echo htmlentities($row['catagory']);?>" class="form-control">
</div>
